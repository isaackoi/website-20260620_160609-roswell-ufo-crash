...
show_ads: true
description: The famous Fort Worth image proves a document was present, but not that its blurred text can settle the Roswell dispute.
hero_summary: The famous Fort Worth image proves a document was present, but not that its blurred text can settle the Roswell dispute.
layout: default
...
title: What Does the Ramey Photo Really Prove?
title_full: What Does the Ramey Photo Really Prove?
display_title_short: Photo Proof
display_title: Photo Proof
heading_title: What Does the Ramey Photo Really Prove?
page_heading_title: What Does the Ramey Photo Really Prove?
source_count: 30
infographic_count: 3
planned_sections:
- The Fort Worth press photograph as contemporary evidence
...
image: /assets/images/Roswell_UFO_crash_f2c9c2_ramey_memo_dispute_f05213_ramey_photo_proof_bb4a2a-Illustration-1-social.jpg
---
...
## What the Photograph Really Proves

When stripped of later interpretations, the original Ramey photograph supports a more modest but defensible conclusion.
...
* Any specific disputed phrase is definitely present.
* The document refers to extraterrestrial craft or [bodies]({{ 'bodies/' | relative_url }}).
